    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sData01 = "직육면체 가로: " + dData01 + "mm 세로: " + dData02 + "mm 높이: " + dData03 + "mm 의";
                sData01 = sData01 + "\n\n부피는 " + dData04 + " 입니다.";
            ...
            {
                label7.Text = "입력 문자열이 형식이 잘못되었습니다.";
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sData01 = "직육면체 가로: " + dData01 + "cm 세로: " + dData02 + "cm 높이: " + dData03 + "cm 의";
                sData01 = sData01 + "\n\n부피는 " + dData04 + " 입니다.";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sData01 = "직육면체 가로: " + dData01 + "m 세로: " + dData02 + "m 높이: " + dData03 + "m 의";
                sData01 = sData01 + "\n\n부피는 " + dData04 + " 입니다.";
